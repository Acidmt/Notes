...
- 等式代换：
  ...
  $\Large 例1：\underset{n\to\infty}{lim}\frac{x}{\sqrt[4]{1+2x}-1}$
...
- 分子分母有理化
  ...
  $\Large 例2：\underset{n\to\infty}{lim}\frac{\sqrt{4x+8}-4}{3-\sqrt{5+x^2}}$
...
- 根式代换(分子分母取最高次幂公倍数)
  ...
  $\Large 例：\underset{n\to\infty}{lim}\frac{\sqrt[3]{x}-1}{\sqrt{x}-1}$
  $$
  \begin{equation*}
  	\begin{aligned}
  \\\Large{解：}\\
