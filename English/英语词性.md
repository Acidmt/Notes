...
注：有少数动词用不带to的不定式来做宾补，即$v+sb\ do$.动词有：<a id="作宾补感官词作宾补感官词">#</a>
...
例2：You don't object `_____`you by your first name, do you?
...
- be done
  ...
  > $It's$ Saturday，so some shops **are** clos**ed.**今天星期六，所以一些商店是关着的。
...
2. 看==空前名词与非谓语==的主被动关系：主动用doing、被动用done
...
注意：这里前四组和前面[作宾补感官词作宾补感官词](#作宾补感官词作宾补感官词)前四组一致。所以这里的前四组可以用：doing$(主动,正在做)$、do$(主动,做完)$、done$(被动)$
...
- 前有`逗号`，后有`名词`。结构：with$+n+doing(主动)/done(被动)$

  > He went into the room，without anyone `noticing` (notice).他走进房间，没有人注意到。

- 前无`逗号`，后无`名词`。结构：主语$...+with+$`____`.此时要判断空和主语关系，主动用doing，被动用being done。
...
>
> 非谓语动词的否定式通常是就在非谓语动词之前加==not或never==。
